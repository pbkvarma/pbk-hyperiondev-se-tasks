...
def reg_user():
    ...
    # - Checks if username already exists in the user.txt file, 
    #   if it does asks to suggest a new name
    while True:
        if new_username in username_password:
            print("\nSorry! username already exists, please type a different username.")
        else:
            break
